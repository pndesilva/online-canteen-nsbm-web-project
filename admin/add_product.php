...
<h3>Category</h3>  
<p>Product type</p>
<input type="number" name="product_type" id="product_type" class="form-control" placeholder="1 breakfast,2 Lunch,3 take away,4 snack,5 Juice,6 Tody special">
<br>
<p>Vendor / Brand</p>
<input type="number" name="brand" id="brand" class="form-control" placeholder="1 Hostel Canteen,2 Auditorium Canteen,3 Eddg 1,4 Eddg,5 Eddg 3">
<br>
<p>Other tags</p>
<input type="text" name="tags" id="tags" class="form-control" placeholder="Best, Good,  etc">
</div>          
</div>
